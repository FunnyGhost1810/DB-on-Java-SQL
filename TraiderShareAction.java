...
public class TraiderShareAction extends BaseModel {
    ...
    private int  operation;         // собственно операции (buy, sell)
    private long traider;           // трейдер, оч связан с классом traider
    private long share;             // акции, с которыми совершена операции , а тут с share
    private long amount;            // количество акций которые подвергаються share
